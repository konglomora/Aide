...
export default React.memo(function SaturationBySelectedOnion() {
    ...
    const [onionCodes, setOnionCodes] = useState('')
    ...
    // const onionCodes = ['DNP', 'ZPR', 'KYI', 'ZHY', 'KHA', 'LVI']
    ...
    function onionCodesInputHandler(e) {
        setOnionCodes(e.target.value)
    }
            ...
            <Flex justify={'center'}>
                <form action="#">
                    <input
                        type={'text'}
                        value={onionCodes}
                        onChange={(e) => onionCodesInputHandler(e)}
                    />
                    <select
                        style={SelectStyle}
